...
const ProcessesContainer = styled(motion.section)`
    padding: 60px 5%;
...
export default function Processes({
    title = "Nuestro Proceso de <strong>Fabricación</strong>",
    subTitle = "Tecnología, seguridad y acabados artesanales para un resultado insuperable en cada pieza.",
    items = []
}) {
    ...
    const activeImage = items[activeIndex]?.image || (items[0]?.image || "");
